    ...
    , ui(new Ui::MainWindow)
{
    ...
    iniTreeWidget();
    connect(ui->menuTree,SIGNAL(itemClicked(QTreeWidgetItem*,int)),this,
            SLOT(menuTree_clicked(QTreeWidgetItem*)));
    connect(ui->addToOrderBtn,SIGNAL(clicked()),this,SLOT(addToOrderBtn1_clicked()));
}
...
// 当点击Tree的Item的事件 col是所点击的列 1001是自定义的type，为TreeWidget的二级item
...
void MainWindow::on_seatConfirmBtn_clicked()
{
    ...
    else
    {
        ...
        // TODO  初始化工作
        this->money=2;
        ui->statusbar->showMessage("正在就餐中");
        if((timer)==nullptr) {
